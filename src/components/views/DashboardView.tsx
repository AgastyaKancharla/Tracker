...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  return (
    <div className="space-y-5 animate-in fade-in duration-200">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-50/80 via-white to-indigo-50/40 p-5 sm:p-6 border border-indigo-100 shadow-xs">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-indigo-50 border border-indigo-200 text-indigo-700 text-xs font-mono mb-2">
              <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
              ChronoTrack Unified Command Center
            </div>
            <h1 className="text-xl sm:text-2xl font-bold text-slate-900 tracking-tight">
              {activeTasks.length > 0 ? (
                <>You have <span className="text-indigo-600">{activeTasks.length} active deliverables</span> on your schedule.</>
              ) : (
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 hover:text-slate-900 text-xs font-medium transition-all shadow-2xs"
            >
              <span>Kanban</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3.5 sm:gap-4">
        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-white border border-slate-200 hover:border-emerald-300 transition-all group relative overflow-hidden shadow-xs hover:shadow-md">
          <div className="flex items-center justify-between mb-3.5">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h3 className="text-sm font-bold text-slate-900">Personal Realm</h3>
                <span className="text-[10px] text-slate-400 font-mono">Wellness & Habits</span>
              </div>
            </div>
            <button 
          ...
          <div className="grid grid-cols-2 gap-2 text-center my-3">
            <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-200/80">
              ...
              <div className="text-[10px] text-slate-500 uppercase">Active Tasks</div>
            </div>
            <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-200/80">
              <div className="text-lg font-bold text-emerald-600 font-mono">
                {habitsDoneToday} / {habits.length}
              </div>
              <div className="text-[10px] text-slate-500 uppercase">Habits Today</div>
            </div>
          </div>
        ...
        {/* Business Hub Card */}
        <div className="p-4 sm:p-5 rounded-2xl bg-white border border-slate-200 hover:border-indigo-300 transition-all group relative overflow-hidden shadow-xs hover:shadow-md">
          <div className="flex items-center justify-between mb-3.5">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h3 className="text-sm font-bold text-slate-900">Business Hub</h3>
                <span className="text-[10px] text-slate-400 font-mono">Operations & Growth</span>
              </div>
            </div>
            <button 
          ...
          <div className="grid grid-cols-2 gap-2 text-center my-3">
            <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-200/80">
              ...
              <div className="text-[10px] text-slate-500 uppercase">Active Ops</div>
            </div>
            <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-200/80">
        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-white border border-slate-200 hover:border-amber-300 transition-all group relative overflow-hidden shadow-xs hover:shadow-md sm:col-span-2 md:col-span-1">
          <div className="flex items-center justify-between mb-3.5">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h3 className="text-sm font-bold text-slate-900">Client Hub</h3>
                <span className="text-[10px] text-slate-400 font-mono">Deliverables & Billing</span>
              </div>
            </div>
            <button 
          ...
          <div className="grid grid-cols-2 gap-2 text-center my-3">
            <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-200/80">
              ...
              <div className="text-[10px] text-slate-500 uppercase">Active Accounts</div>
            </div>
            <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-200/80">
          ...
          <div className="text-[11px] text-slate-500 flex items-center justify-between pt-2 border-t border-slate-100">
            ...
            <button 
              ...
              className="text-amber-600 font-medium hover:underline flex items-center gap-0.5"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-6">
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-white border border-slate-200 space-y-4 shadow-xs">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-sm font-bold text-slate-900">Target Deadlines & Countdown Radar</h2>
              </div>
              <span className="text-xs font-mono px-2 py-0.5 rounded bg-indigo-50 text-indigo-700 border border-indigo-200 font-medium">
                {sortedDeadlines.length} active items
              </span>
            </div>

            {sortedDeadlines.length === 0 ? (
              <div className="py-10 text-center border border-dashed border-slate-200 rounded-xl space-y-3 p-4 bg-slate-50/50">
                <div className="w-10 h-10 rounded-full bg-indigo-50 text-indigo-600 flex items-center justify-center mx-auto">
                  <Sparkles className="w-5 h-5" />
                </div>
                <div>
                  <p className="text-xs text-slate-800 font-semibold">No deadlines on your radar</p>
                ...
                <div className="flex flex-wrap items-center justify-center gap-2 pt-1">
                  <button
                    onClick={() => onOpenTaskModal('personal')}
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-50 border border-emerald-200 text-emerald-700 hover:bg-emerald-100 text-xs font-medium transition-colors"
                  >
                  ...
                  <button
                    onClick={() => onOpenTaskModal('client')}
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-amber-50 border border-amber-200 text-amber-800 hover:bg-amber-100 text-xs font-medium transition-colors"
                  >
                    <Plus className="w-3.5 h-3.5" />
              ...
              <div className="space-y-2.5">
                {sortedDeadlines.map((item) => {
                  ...
                  return (
                    <div
                      key={item.id}
                      className="p-3 sm:p-3.5 rounded-xl bg-slate-50/80 hover:bg-slate-100/80 border border-slate-200 hover:border-slate-300 transition-all group space-y-2 shadow-2xs"
                    >
                      <div className="flex items-center justify-between gap-3">
                        <div className="flex items-center gap-2.5 sm:gap-3 overflow-hidden">
                          ...
                          <button
                            ...
                            className="w-5 h-5 rounded-md border border-slate-300 hover:border-emerald-600 text-transparent hover:text-emerald-600 flex items-center justify-center transition-all flex-shrink-0 bg-white"
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-white border border-slate-200 space-y-4 shadow-xs">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-sm font-bold text-slate-900">Active In-Progress Sprint</h2>
              </div>
              <button 
                onClick={() => onSelectView('kanban')}
            ...
            {inProgressTasks.length === 0 ? (
              <div className="py-6 text-center border border-dashed border-slate-200 rounded-xl bg-slate-50/50">
                <p className="text-xs text-slate-600">No tasks currently marked &quot;In Progress&quot;.</p>
                <p className="text-[11px] text-slate-400 mt-1">Move tasks to In Progress on your Kanban board to focus your day.</p>
              </div>
            ) : (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {inProgressTasks.map((task) => (
                  <div
                    ...
                    className="p-3.5 rounded-xl bg-slate-50/80 border border-slate-200 hover:border-slate-300 transition-all cursor-pointer space-y-2 group shadow-2xs"
                  >
                    <div className="flex items-center justify-between">
        ...
        <div className="space-y-5 sm:space-y-6">
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-white border border-slate-200 space-y-3.5 shadow-xs">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold text-slate-900">Daily Discipline</h3>
              </div>
              <button
            ...
            {habits.length === 0 ? (
              <div className="py-6 text-center border border-dashed border-slate-200 rounded-xl space-y-2 bg-slate-50/50">
                <p className="text-xs text-slate-600">No habit routines added yet.</p>
                <button
                  onClick={() => onSelectView('habits')}
                    ...
                    >
                      <div className="flex items-center gap-2.5 overflow-hidden">
                        <div className={`w-4 h-4 rounded-full border flex items-center justify-center text-[10px] ${
                          isDone ? 'bg-emerald-600 border-emerald-600 text-white font-bold' : 'border-slate-300 bg-white'
                        }`}>
                          {isDone && '✓'}
                        </div>
                        <span className={`text-xs truncate ${isDone ? 'text-emerald-900 font-semibold' : 'text-slate-700'}`}>
                          {habit.title}
                        </span>
                      </div>

                      <span className="text-[10px] font-mono text-orange-600 font-bold flex items-center gap-0.5 flex-shrink-0">
                        🔥 {habit.streak}d
                      </span>
                    </div>
                  );
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-white border border-slate-200 space-y-3.5 shadow-xs">
            ...
            {clients.length === 0 ? (
              <div className="py-6 text-center border border-dashed border-slate-200 rounded-xl space-y-2 bg-slate-50/50">
                <p className="text-xs text-slate-600">No registered client accounts.</p>
                <button
                  onClick={() => onSelectView('clients')}
              ...
              <div className="space-y-3">
                {clients.map((client) => {
                  ...
                  return (
                    <div key={client.id} className="p-3 rounded-xl bg-slate-50/80 border border-slate-200 space-y-2">
                      <div className="flex items-center justify-between">
